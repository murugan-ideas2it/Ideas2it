...
?>
	...
	<article id="post-<?php echo $post_id; ?>" data-id="<?php echo $post_id; ?>" <?php post_class(); ?>>
		...
		<?php if( current_user_can( 'edit_post', $post_id ) ){  ?>
			...
			<ul class="admin-menu">
				<li><a href="" class="title" data-title="<?php the_title(); ?>"><?php echo __('Edit Video Title', 'persona'); ?></a></li>
				<li><a href="" class="trash not-trashed"><?php echo __('Trash Video', 'persona'); ?></a></li>
			</ul>
