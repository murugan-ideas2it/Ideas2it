...
class SimpleWpMapBuilder {
    ...
    public function generateContent () {
        $q = new WP_Query(array('post_type' => 'any', 'post_status' => 'publish', 'posts_per_page' => 50000, 'has_password' => false, 'orderby' => $this->orderby ? 'modified' : 'date'));
    ...
    public function printOutput () {
        if ($this->xml) {
            ...
            echo '<!doctype html><html lang="', get_locale(), '"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>', $name, ' ', __('Html Sitemap', 'simple-wp-sitemap'), '</title><link rel="stylesheet" href="', $this->url, 'css/html.css"></head><body><div id="wrapper"><h1><a href="', $this->homeUrl, '">', $name, '</a> ', __('Html Sitemap', 'simple-wp-sitemap'), '</h1>';
            $this->sortAndPrintSections();
            echo '</div></body></html>';
        }
    }
