...
class persona_image_widget extends WP_Widget {
	function Persona_Image_Widget() {
		// Widget settings
		$widget_ops = array( 'classname' => 'widget-selected-image', 'description' => __('Choose the image post you want to display.', 'persona') );

		// Widget control settings
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'persona_image_widget' );

		// Create the widget
		$this->WP_Widget( 'persona_image_widget', 'Image', $widget_ops, $control_ops );
	}
